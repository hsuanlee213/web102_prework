...
function filterUnfundedOnly() {
    ...
    const gameList = GAMES_JSON.filter(game => {
        return game.goal > game.pledged;
    });

    // console.log("Unfunded games count:", gameList.length);
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${fundedCount} games, ${
    unfundedCount === 1
        ? `${unfundedCount} game remains unfunded.`
